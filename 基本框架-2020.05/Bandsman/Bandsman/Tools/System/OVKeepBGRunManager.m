...
static OVKeepBGRunManager *_sharedManger;

@interface OVKeepBGRunManager ()
...
@implementation OVKeepBGRunManager {
...
+ (OVKeepBGRunManager *)shareManager{
    ...
    dispatch_once(&onceToken, ^{
        if (!_sharedManger) {
            _sharedManger = [[OVKeepBGRunManager alloc] init];
        }
    });
